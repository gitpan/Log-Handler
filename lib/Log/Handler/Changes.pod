...
The layout can be defined with the option C<message_layout>. C<prefix> is
deprecated as well.
...
This is still running fine, but deprecated. It creates a C<Log::Handler::Simple>
object with all features of C<Log::Handler> in version 0.38.
